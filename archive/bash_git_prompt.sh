...
if tput setaf 1 &> /dev/null; then
  ...
  if [[ "$(tput colors)" -ge 256 ]] &> /dev/null; then
    ...
    sexy_bash_prompt_gray_color="$(tput setaf 27)" # BOLD GRAY
...
SEXY_ORIG="\[$sexy_bash_prompt_user_color\]\u\[$sexy_bash_prompt_reset\] \
...
\$( sexy_bash_prompt_is_on_git && \
  ...
  echo \"\[$sexy_bash_prompt_git_status_color\]\$(sexy_bash_prompt_get_git_info)\" && \
  echo \"\[$sexy_bash_prompt_git_progress_color\]\$(sexy_bash_prompt_get_git_progress)\" && \
  echo \"\[$sexy_bash_prompt_preposition_color\]\")\[$sexy_bash_prompt_reset\]\
\[$sexy_bash_prompt_symbol_color\]$sexy_bash_prompt_symbol \[$sexy_bash_prompt_reset\]"

SIMPLIFIED="\[$sexy_bash_prompt_dir_color\]\w\[$sexy_bash_prompt_reset\]\
\$( sexy_bash_prompt_is_on_git && \
  echo \" \[$sexy_bash_prompt_preposition_color\]on\[$sexy_bash_prompt_reset\] \[$sexy_bash_prompt_git_status_color\]\$(sexy_bash_prompt_get_git_info)\" && \
  echo \"\[$sexy_bash_prompt_git_progress_color\]\$(sexy_bash_prompt_get_git_progress)\[$sexy_bash_prompt_preposition_color\]\"
)\[$sexy_bash_prompt_reset\]\[$sexy_bash_prompt_symbol_color\]$sexy_bash_prompt_symbol \[$sexy_bash_prompt_reset\]"

SIMPLIFIED_GIT_FIRST="\
\$( sexy_bash_prompt_is_on_git && \
  echo \" - \[$sexy_bash_prompt_user_color\]git:\[$sexy_bash_prompt_reset\] \[$sexy_bash_prompt_git_status_color\]\$(sexy_bash_prompt_get_git_info)\" && \
  echo \"\[$sexy_bash_prompt_git_progress_color\]\$(sexy_bash_prompt_get_git_progress)\[$sexy_bash_prompt_preposition_color\]\"
)\
\[$sexy_bash_prompt_dir_color\]\w\[$sexy_bash_prompt_reset\]\
\[$sexy_bash_prompt_reset\]\[$sexy_bash_prompt_symbol_color\]$sexy_bash_prompt_symbol \[$sexy_bash_prompt_reset\]"
...
export PS1=$SIMPLIFIED_GIT_FIRST
